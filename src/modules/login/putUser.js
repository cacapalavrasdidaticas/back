    ...
    try {
        ...
        const query = `
            ...
            SET nome = COALESCE($1, nome),
                ...
                -- Aqui estamos adicionando a nova data ao array de termos
                termos = CASE
                           WHEN termos IS NULL THEN ARRAY[$13::TIMESTAMP]
                           ELSE array_append(termos, $13::TIMESTAMP)
                         END
            WHERE id = $14
            RETURNING *;
        `;
        ...
        const updatedAccount = await db.one(query, [
            ...
            pais ?? null,
            hashedSenha ?? null,
            termosData ? termosData.toISOString() : null,  // Adicionando a data convertida
            id
        ]);
